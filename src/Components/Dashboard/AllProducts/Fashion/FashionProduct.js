...
import FashionProductDetails from './FashionProductDetails';
...
const FashionProduct = () => {
    ...
    useEffect(() => {
        setLoading(true)
        fetch('https://eco-shop-db.herokuapp.com/fashion')
            .then(res => res.json())
            .then(data => {
                console.log(data)
                setProducts(data);
        ...
        <div className="font mt-4 mb-5 container-fluid">
            ...
            <div className="allProducts d-flex justify-content-center ">
                ...
                <div className="w-75 row">
                    {
                        products.map(product => <FashionProductDetails key={product._id} product={product} />)
                    }
                </div>
